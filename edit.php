    ...
    <div class="form-div">
        <form class="edit-form" action="<?php echo $SERVER['PHP_SELF']?>" method="post">
            ...
            <div>
                ...
                <input  class="input-field" type="date" name="motori"  value="<?php echo $vetura['Motori']?>">
            </div><br>
            ...
            <input class="edit-submit" type="submit" name="editBtn" value="Save Changes" href="AdminDashboard.php">
        </form>
    </div>
